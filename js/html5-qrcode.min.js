                ...
                if (d[j + f * qrcode.width])
                    ...
                    if (4 == h)
                        if (this.foundPatternCross(g)) {
                            if (h =
                            this.handlePossibleCenter(g, f, j))
                                b = 2,
...
function AlignmentPattern(d, a, c) {
    ...
    this.aboutEquals = function(b, a, c) {
        ...
        (b = Math.abs(b - this.estimatedModuleSize),
        1 >= b || 1 >= b / this.estimatedModuleSize) : !1
    }
}
...
(function(d){
    d.fn.html5_qrcode=function(a,c,b){
        ...
        e=function(a){
            ...
            h.play();
            setTimeout(k,1E3)};
            navigator.getUserMedia?navigator.getUserMedia({video:!0},e,b):console.log("Native web camera streaming (getUserMedia) not supported in this browser.");
            qrcode.callback=a
        }
    })(jQuery);*/
